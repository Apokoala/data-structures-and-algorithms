...
const containsAnd = (arr) => arr.filter(and => and.includes('and'));

//i tried very hard to put a .toLowerCase in here but i couldnt figure it out.
...
const notInFirstArray = (forbiddenValues, arr) => arr.filter(value => forbiddenValues.includes(value) !== true);
