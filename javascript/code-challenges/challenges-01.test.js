...
const addExclamation = (arr) => {
  const localArray = [];
  arr.forEach(exclaim => localArray.push(exclaim + '!'));
  return localArray;
};
...
const allUpperCase = (arr) => {
  const localArray = [];
  arr.forEach(uppies => localArray.push(uppies.toUpperCase()));
  return localArray;
};
...
const speaker = (words, callback) => {
  const localArray = [];
  words.forEach(greeting => localArray.push(callback(greeting)));
  return localArray;
};
